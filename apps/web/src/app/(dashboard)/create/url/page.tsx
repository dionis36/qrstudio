...
import { URLForm } from '@/components/wizard/forms/URLForm';
import { PhoneMockup } from '@/components/common/PhoneMockup';
import { URLPreview } from '@/components/wizard/preview/URLPreview';
    ...
    return (
        <div className="w-full px-3 sm:px-6 pb-20">
            <SEO
                ...
                description="Create a QR code that links to any website or URL"
            />
            ...
            <div className="flex flex-col lg:flex-row gap-8">
                ...
                <div className="w-full lg:w-3/4 flex flex-col">
                    ...
                    <div className="mt-8 pt-6 border-t border-slate-100 flex justify-end">
                        <button
                            onClick={() => router.push(`/create/url/design${editId ? `?edit=${editId}` : ''}`)}
