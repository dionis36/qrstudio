...
import { SocialMediaPageForm } from '@/components/wizard/forms/SocialMediaPageForm';
import { PhoneMockup } from '@/components/common/PhoneMockup';
import { SocialMediaPagePreview } from '@/components/wizard/preview/SocialMediaPagePreview';
...
export default function SocialMediaPage() {
    ...
    const handleNext = () => {
        router.push(`/create/socialmedia/design${editId ? `?edit=${editId}` : ''}`);
    };
                    ...
                    <div className="sticky top-6 w-full flex flex-col items-center h-fit">
                        <div className="transform transition-all duration-500 origin-top scale-[0.85] xl:scale-[0.9]">
                            <PhoneMockup className="shadow-2xl shadow-slate-300/50">
                                <SocialMediaPagePreview data={payload} />
                            </PhoneMockup>
                        </div>
                    </div>
                </div>
