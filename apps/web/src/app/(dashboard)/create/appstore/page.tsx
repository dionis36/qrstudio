...
import { AppStoreForm } from '@/components/wizard/forms/AppStoreForm';
import { PhoneMockup } from '@/components/common/PhoneMockup';
import { AppStorePreview } from '@/components/wizard/preview/AppStorePreview';
...
export default function AppStorePage() {
    ...
    const handleNext = () => {
        router.push(`/create/appstore/design${editId ? `?edit=${editId}` : ''}`);
    };
