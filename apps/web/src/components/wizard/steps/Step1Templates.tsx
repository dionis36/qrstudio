...
const TEMPLATES = [
    ...
    { id: 'wifi', label: 'Wi-Fi', desc: 'Connect to Wi-Fi network', icon: Wifi, color: 'bg-indigo-100 text-indigo-600', available: true },
    { id: 'file', label: 'File', desc: 'Share any file type easily', icon: File, color: 'bg-red-100 text-red-600', available: true },
    { id: 'text', label: 'Text', desc: 'Display plain text message', icon: FileText, color: 'bg-slate-100 text-slate-600', available: true },
    { id: 'event', label: 'Event', desc: 'Add event to calendar instantly', icon: Calendar, color: 'bg-purple-100 text-purple-600', available: true },
    { id: 'email', label: 'Email', desc: 'Send pre-filled email message', icon: Mail, color: 'bg-pink-100 text-pink-600', available: false },
    { id: 'sms', label: 'SMS', desc: 'Send instant text message', icon: MessageSquare, color: 'bg-green-100 text-green-600', available: false },
    { id: 'app', label: 'App Store', desc: 'Direct link to app download', icon: Smartphone, color: 'bg-cyan-100 text-cyan-600', available: false },
